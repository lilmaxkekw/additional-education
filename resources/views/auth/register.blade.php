...
@if($errors->any())
    <div
        class="alert flex flex-row items-center bg-red-200 p-5 rounded border-b-2 border-red-300 mb-5 absolute items-center m-0">
        <div
...
{{--h-screen--}}
<div id="personalData" class="modal  w-full fixed left-0 top-0 flex justify-center items-center hidden"
        ...
        <div class="p-4 max-h-screen overflow-y-auto">
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6 flex justify-center">
                <label class="block text-sm font-medium text-gray-700">
                    ...
                    веб-сайте httpsː//thismywebsite·com;
