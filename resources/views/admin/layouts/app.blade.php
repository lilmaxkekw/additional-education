            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('admin.index') }}" class="text-white px-3 py-2 hover:bg-gray-700 hover:text-white rounded-md text-sm font-mediumhover:bg-gray-700 hover:text-white ">Главная</a>
                        <a href="{{ route('courses.index') }}" class="text-white px-3 py-2 hover:bg-gray-700 hover:text-white rounded-md text-sm font-medium">Курсы</a>
                        <a href="{{ route('categories.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Категории</a>
                    </div>
                </div>
            </div>
